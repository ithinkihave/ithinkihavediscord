...
type VersionCommandInteraction = NamedChatInputCommandInteraction<typeof VERSION_COMMAND_NAME>;

export async function handleVersionCommand(interaction: VersionCommandInteraction) {
  try {
