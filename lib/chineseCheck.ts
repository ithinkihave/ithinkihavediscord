...
function shouldDeleteDisallowedChineseChannelMessage(message: DiscordMessage): boolean {
...
export async function handleChineseChannelEnglishCheck(message: DiscordMessage): Promise<boolean> {
